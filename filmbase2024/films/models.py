...
class FilmCrew(MyModel):
    name = models.CharField("Профессия", max_length=1024)
    film = models.ForeignKey(Film, verbose_name="Фильм", on_delete=models.CASCADE, related_name="crew")
    people = models.ManyToManyField(Person, verbose_name="Участник")
    class Meta:
        ordering = ["name"]
