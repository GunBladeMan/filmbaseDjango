...
urlpatterns = [
    ...
    path('genres/<int:id>/delete/',
     ...
     path('genres/autocomplete/',
         views.GenreAutocomplete.as_view(), name='genres_autocomplete'),
    ...
    path('films/<int:id>/create_crew/',
         views.crew_create, name='crew_create'),
    path('films/<int:id>/update_crew/',
         views.crew_update, name='crew_update'),
    path('films/<int:id>/delete_crew/',
         views.crew_delete, name='crew_delete'),
    ...
    path('people/autocomplete/',
         views.PersonAutocomplete.as_view(), name='people_autocomplete'),
]
